...
export async function DELETE(request, { params }) {
  try {
    ...
    const id = params.id;
    const result = await query("UPDATE sitios_partners SET activo = false WHERE id = $1 RETURNING *", [id]);
    ...
    console.error("Error en DELETE /api/admin/partners/[id]:", error);
    return Response.json(
