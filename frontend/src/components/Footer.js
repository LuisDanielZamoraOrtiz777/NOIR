        ...
        <div className="footer-grid">
          ...
          <div className="footer-nav">
            ...
            <ul>
              ...
              <li><Link href="/tendencias">Tendencias</Link></li>
              <li><Link href="/looks">Looks</Link></li>
              <li><Link href="/editor">Colaborar</Link></li>
          ...
          <div className="footer-newsletter">
            ...
            <form onSubmit={handleSubscribe} className="newsletter-form">
              ...
              {status === "ok" && <p className="success" role="status">Gracias por suscribirte.</p>}
              {status === "error" && (
                <p className="error" role="alert">
                  {errorMessage || "Error al suscribir. Intenta luego."}
                </p>
              )}
            </form>
          </div>
